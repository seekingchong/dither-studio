...
export function toPipelineOptions(params: Params): PipelineOptions {
  ...
  return {
    ...
    halftone: {
      ...
      holes: bool(params, 'halftone.holes'),
      holeStart: num(params, 'halftone.holeStart') / 100,
      holeSize: num(params, 'halftone.holeSize') / 100,
      field: num(params, 'halftone.field') / 100,
