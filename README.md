...
- 网点：规则网格上按明暗放大缩小的矢量点。形状 8 种（圆 / 方 / 圆角方 / 菱形 / 三角 / 六边形 / 线条 / 十字）、网点大小与最小网点、面积或直径正比的响应、网点增益、灰阶分级（2–32 档）、点融合（距离场 smooth-min，单独的小点不会被吃掉）、暗部反白（墨量过了起点的格子翻成黑底挖白孔，黑底大过格子、相邻的连成一片圆鼓边的黑区，白孔越暗越小；起点、白孔大小、黑底大小可调）、抗锯齿开关；网格横向 / 纵向中心距、角度、方格或交错排列、偏移；颜色双色（网点色 + 背景色）/ 原图色 / CMYK 四层分色叠印（青 15° 品 75° 黄 0° 黑 45°）；边缘抗锯齿，CPU 渲染
...
- 体验：内置预设 32 个（抖动 11、排线 9：Hatching、Pencil、Engraving、Crosshatch、Woodcut、Rain、Beads、Blueprint Lines、Brick；网点 12：默认、Poster、Newsprint、Comic、CMYK Print、Ink Blob、Line Screen、Mosaic、Triangles、Color Dots、Pixel Dots、Honeycomb）、用户预设（按风格分页显示，「历史」页都在）、撤销重做与快捷键（切风格页签也可撤销）、浅 / 深主题、GPU（WebGL2）开关；默认方案是有序 Bayer 2×2 单色，每种风格记住上次用的方案
